...
// Création d'une instance de la classe Systeme
$systeme = new Systeme();
// Récupération des auteurs grâce à une méthode de l'instance système
$auteurs = $systeme->getAuteurs();
// Transformation de la liste des auteurs en une liste de noms complets
